...
using GA_TallerMVC.Data;
using GA_TallerMVC.Models;

namespace GA_TallerMVC.Controllers
{
    public class BurgersController : Controller
    {
        private readonly GA_TallerMVCContext _context;

        public BurgersController(GA_TallerMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'GA_TallerMVCContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GA_TallerMVCContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
